...
class IseedCommand extends Command
{
    ...
    public function fire()
    {
        ...
        if ($this->option('clean')) {
            app('\Orangehill\Iseed\Iseed')->cleanSection();  // @Leey
        }
        ...
        foreach ($tables as $table) {
            ...
            if (!file_exists($fileName) || $this->option('force')) {
                $this->printResult(
                    app('\Orangehill\Iseed\Iseed')->generateSeed(
                        $table,
    ...
    protected function getOptions()
    {
        return array(
            ...
            array('offset', null, InputOption::VALUE_OPTIONAL, 'start number of rows', null),
            array('file', null, InputOption::VALUE_OPTIONAL, 'force the content to file, explode by string _ as folder ', null),
    ...
    protected function generateFileName($table)
    {
        ...
        $className = app('\Orangehill\Iseed\Iseed')->generateClassName($table);
